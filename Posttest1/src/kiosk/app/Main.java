...
public class Main {
    public static void main(String[] args) {
        ...
        menuMakanan m1 = new menuMakanan(1, "Combo 1 Fire Chicken", 35000, "Makanan");
        menuMakanan d1 = new menuMakanan(5, "Pink Lava", 15000, "Minuman");
        ...
        do {
            ...
            switch (pilihan) {
                case 1:
                    ...
                    String detMakan = "Level " + input.nextInt();
